          ...
          <form class="form-inline my-2 my-lg-0">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item active" style="padding-right:20px">
                <a class="nav-link" href="{{ url('admin-musicians') }}" style="font-family:quicksand;color: #61BDDC !important;font-weight:bold">Musician List</a>
              </li>
              <li class="nav-item active"  style="padding-right:20px">
                <a class="nav-link" href="{{ url('/admin-bands') }}"style="font-family:quicksand;color: #61BDDC !important;font-weight:bold">Band List</a>
              </li>
