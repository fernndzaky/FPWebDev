...
<div class="container">
    <div class="row m-0">
        <div class="col-sm-12"style="text-align:center">
            ...
            <p id="apps-txt"class="wow tada"style="font-family: Quicksand;font-weight: bold;font-size: 50px;text-align: center;color: #2EA8D1;"> SUCCESSFULY APPLIED TO THE MUSICIAN !</p>
