...
<div class="container">
    <div class="row m-0" style="padding: 80px 0px">
        <div class="col-sm-6 wow fadeInLeft" style="text-align:center" >
            <img id="bassist-img"class="img-fluid"src="assets/bassist 1.png" alt="">
        </div>
        ...
        {{ Form::open(array('action' => 'UsersController@findMusician2')) }}
                ...
                <div class="form-group">
                    ...
                    <label for="instrument">INSTRUMENT</label>
                        ...
                        <option value="1">Pianist</option>
                        <option value="2">Drummer</option>
                        <option value="3">Singer</option>
                        <option value="4">Guitarist</option>
                        <option value="5">Bassist</option>
