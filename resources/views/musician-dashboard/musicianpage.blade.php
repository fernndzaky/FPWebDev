    ...
    <div class="row m-0" style="padding-top:30px">
        ...
        <div class="col-sm-8 pl-0">
            ...
            <div style = "text-align:left">
                ...
                <p style="font-family: Quicksand;font-weight: bold;font-size: 18px;color: #61BDDC" >Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.

                </p>
            </div>
                <div class="row p-0 m-0" style="padding-top:80px">
                    <div class="col-sm-6 pl-0" style="padding-top:10px">
                        <h1 style="font-family: Quicksand;font-weight: bold;font-size: 24px;color: #61BDDC">
